    ...
    >
      ...
      <div className="p-3">
        <NavSection title="Main" isOpen={isOpen}>
          <NavItem icon={Home} label="Dashboard" to="/" isOpen={isOpen} isActive />
          <NavItem icon={Users} label="Students" to="/students" isOpen={isOpen} />
          <NavItem icon={BookOpen} label="Teachers" to="/teachers" isOpen={isOpen} />
          <NavItem icon={BookText} label="Courses" to="/courses" isOpen={isOpen} />
        </NavSection>
