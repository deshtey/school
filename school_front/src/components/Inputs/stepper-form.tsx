...
import { faCircleCheck, faShoppingCart, faUserGroup, faVideo } from '@fortawesome/free-solid-svg-icons';
...
function ColorlibStepIcon(props: StepIconProps) {
  ...
  const icons: { [index: string]: React.ReactElement<unknown> } = {
    ...
    2: <FontAwesomeIcon icon={faUserGroup} />,
    3: <FontAwesomeIcon icon={faVideo} />,
  };
