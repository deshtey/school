  ...
  return (
    <div className='flex flex-col m-2 gap-8 '>
      <div className='flex flex-col gap-8 '>
        <div className='overflow-hidden rounded-2xl border border-[#d6b6d7] p-4 flex flex-col  items-start self-stretch relative w-full '>
          <div className='flex justify-between items-center relative  bg-transparent'>
            <div className='flex gap-4 items-center relative bg-transparent'>
              ...
              <h5 className='text-center font-semibold leading-6 text-xl text-[#353535]  dark:text-light'>Subscription plan</h5>
            </div>
          </div>
            ...
            <div className='flex gap-8 items-center self-stretch relative w-full bg-transparent'>
              <div className='flex flex-col gap-2 items-center relative w-[345px] bg-transparent'>
                <div className='flex flex-col gap-5 items-center self-stretch relative w-full bg-transparent'>
                  ...
                  <h5 className='text-center font-semibold leading-[30px] text-xl text-[#252525] dark:text-light dark:text-light'>Basic plan</h5>
                </div>
                <h1 className='tracking-[-0.096em] text-center font-semibold leading-[60px] text-5xl text-[#101828] dark:text-light'>
                  $10/mth
                </h1>
                <p className='text-center leading-6 text-base text-[#475467] dark:text-light'>Billed annually.</p>
              </div>
              <div className='flex flex-col gap-4 items-start relative w-[677px] bg-transparent'>
                <div className='flex gap-3 items-start self-stretch relative w-full bg-transparent'>
                  ...
                  <div className='flex flex-col gap-0 items-start flex-1 relative w-full bg-transparent'>
                    <p className='leading-6 text-base text-[#475467] dark:text-light'>Access to all basic features</p>
                  </div>
                </div>
                <div className='flex gap-3 items-start self-stretch relative w-full bg-transparent'>
                  <svg width='24' height='24' viewBox='0 0 24 24' fill='none' xmlns='http://www.w3.org/2000/svg'>
                  ...
                  <div className='flex flex-col gap-0 items-start flex-1 relative w-full bg-transparent'>
                    <p className='leading-6 text-base text-[#475467] dark:text-light'>Basic reporting and analytics</p>
                  </div>
                </div>
                <div className='flex gap-3 items-start self-stretch relative w-full bg-transparent'>
                  <svg width='24' height='24' viewBox='0 0 24 24' fill='none' xmlns='http://www.w3.org/2000/svg'>
                  ...
                  <div className='flex flex-col gap-0 items-start flex-1 relative w-full bg-transparent'>
                    <p className='leading-6 text-base text-[#475467] dark:text-light'>Up to 10 individual users</p>
                  </div>
                </div>
                <div className='flex gap-3 items-start self-stretch relative w-full bg-transparent'>
                  <svg width='24' height='24' viewBox='0 0 24 24' fill='none' xmlns='http://www.w3.org/2000/svg'>
                  ...
                  <div className='flex flex-col gap-0 items-start flex-1 relative w-full bg-transparent'>
                    <p className='leading-6 text-base text-[#475467] dark:text-light'>20GB individual data each user</p>
                  </div>
                </div>
                <div className='flex gap-3 items-start self-stretch relative w-full bg-transparent'>
                  <svg width='24' height='24' viewBox='0 0 24 24' fill='none' xmlns='http://www.w3.org/2000/svg'>
                  ...
                  <div className='flex flex-col gap-0 items-start flex-1 relative w-full bg-transparent'>
                    <p className='leading-6 text-base text-[#475467] dark:text-light'>Basic chat and email support</p>
                  </div>
                </div>
                <div className='flex gap-3 items-start self-stretch relative w-full bg-transparent'>
                  <div className='flex flex-col gap-0 items-start flex-1 relative w-full bg-transparent'>
                    <p className='leading-6 text-base text-[#475467] dark:text-light'>Expires 10th August 2025</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className='flex gap-2 items-start relative bg-transparent'>
          ...
          <div className='rounded-2xl border-[1.5px] border-[#475467] pl-2.5 pr-1.5 py-1 flex gap-1 justify-center items-center relative bg-[#f8f7fd]'>
            <small className='text-center leading-[18px] text-xs text-[#252525] dark:text-light'>Billing history</small>
          </div>
          <div className='rounded-2xl border-[1.5px] border-[#475467] pl-2.5 pr-1.5 py-1 flex gap-1 justify-center items-center relative bg-[#f8f7fd]'>
            <small className='text-center leading-[18px] text-xs text-[#252525] dark:text-light'>Images</small>
          </div>
          <div className='rounded-2xl border-[1.5px] border-[#475467] pl-2.5 pr-1.5 py-1 flex gap-1 justify-center items-center relative bg-[#f8f7fd]'>
            <small className='text-center leading-[18px] text-xs text-[#252525] dark:text-light'>Videos</small>
          </div>
          <div className='rounded-2xl border-[1.5px] border-[#475467] pl-2.5 pr-1.5 py-1 flex gap-1 justify-center items-center relative bg-[#f8f7fd]'>
            <small className='text-center leading-[18px] text-xs text-[#252525] dark:text-light'>Audios</small>
          </div>
        </div>
      </div>
        ...
        <div className='overflow-hidden rounded-2xl border border-[#d6b6d7] p-8 flex flex-col gap-4 items-start self-stretch relative w-full h-[329px] '>
          ...
          <div className='flex flex-col gap-6 items-start relative h-[295px] bg-transparent'>
            <div className='flex flex-col gap-2 justify-center items-start relative bg-transparent'>
              <p className='font-medium text-base text-[#1c1b1f] dark:text-light'>Manage your payment methods</p>
              <small className='text-sm text-[#8c8c8c] dark:text-light'>Add, update, or remove your payment methods</small>
            </div>
            <div className='flex flex-col gap-4 items-start relative bg-transparent'>
              <div className='flex justify-between items-center self-stretch relative w-full bg-transparent'>
                <div className='flex gap-2 justify-center items-center relative bg-transparent'>
                  ...
                  />
                  <small className='text-sm text-[#474554] dark:text-light'>Phone number ending in 82</small>
                </div>
