...
export default function TeacherNewEditForm({ currentTeacher }) {
  ...
  const defaultValues = useMemo(
    () => ({
      ...
      company: currentTeacher?.company || '',
      avatarUrl: currentTeacher?.avatarUrl || null,
  ...
  const onSubmit = handleSubmit(async (data) => {
    try {
      ...
      reset();
      enqueueSnackbar(currentTeacher ? 'Update success!' : 'Create success!');
      router.push(paths.dashboard.Teacher.list);
