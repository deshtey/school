...
export function AdminLayout({ sx, children, data }) {
  ...
  const navData = data?.nav ?? adminNavData;
    ...
    <>
      ...
      <LayoutSection
        ...
        cssVars={{
          ...
          '--layout-admin-content-pt': theme.spacing(1),
          '--layout-admin-content-pb': theme.spacing(8),
          '--layout-admin-content-px': theme.spacing(5),
        }}
        sx={{
